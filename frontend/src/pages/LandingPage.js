            ...
            <div>
              ...
              <div className="mt-6 p-4 bg-[#D97757]/5 border border-[#D97757]/20 rounded-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 max-w-4xl">
                <div>
                  ...
                  <p className="text-xs text-[#75716B]">AI search, reading plans, bookmarks, share as image, and 200+ verses</p>
                </div>
            ...
            <div className="lg:col-span-8">
              <div className="grid sm:grid-cols-2 gap-x-8 gap-y-10">
                {[
                  ...
                  { icon: Search, title: "Keyword Search", desc: "Quick text matching across 200+ verses from 16 texts. Filter by any scripture." },
