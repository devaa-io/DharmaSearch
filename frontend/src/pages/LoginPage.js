    ...
    <div className="min-h-screen bg-[#FDFBF7] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#75716B]">Sign in to continue your journey</p>
        </div>

        <div className="bg-white border border-[#E8E3D9] rounded-2xl p-8 shadow-sm">
          <form onSubmit={handleSubmit} data-testid="login-form">
            {error && (
              <div className="bg-red-50 text-red-700 rounded-xl px-4 py-3 text-sm mb-4" data-testid="login-error">
                {error}
              </div>
            )}
            <div className="mb-4">
        ...
        <p className="text-center mt-6 text-[#75716B]">
          ...
          <Link to="/register" className="text-[#D97757] font-medium hover:underline" data-testid="login-register-link">
            Create one
          </Link>
        </p>
      </div>
